...
export default function Login() {
      const [values , setValues ] = useState({
       ...
       const errorMesagge = new URLSearchParams(location.search).get('message');
                ...
                <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                    <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            {/* {ternary untuk mengecek apakah halaman diakses dengan mengirim params dgn url  } */}
                            {
                                errorMesagge ?(
                                    <div class ="bg-red-100 border-t border-b border-red-500 text-red-700 px-4 py-3" role="alert">
                                        <p class="font-bold">gagal proses halaman</p>
                                        <p class="text-sm">{errorMesagge}</p>
                                        </div>
                                ) :''
                            }
                            {/* {ternary untuk mengecek apakah  state error memiliki data,jika iya munculkan datanya dgn looping} */}
                            {
